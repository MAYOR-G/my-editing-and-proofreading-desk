...
export default function SignUpPage() {
  return (
    <main className="min-h-screen bg-ivory text-ink">
      <SiteHeader />
      <section className="grid min-h-screen px-5 pb-16 pt-24 sm:px-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-start lg:gap-12 lg:pt-36">
        {/* Left: Visual + Copy */}
        <div className="mx-auto w-full max-w-xl lg:justify-self-end">
          <p className="text-xs uppercase tracking-[0.32em] text-primary">Sign up</p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            {trustBadges.map((badge) => (
              <span key={badge.label} className="flex items-center gap-2 border border-hairline bg-surface-soft px-3 py-2 text-xs uppercase tracking-[0.16em] text-charcoal/60">
