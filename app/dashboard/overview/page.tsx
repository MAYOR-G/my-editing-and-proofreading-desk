  ...
  return (
    <>
      <div className="grid gap-8 border-b border-ink/10 pb-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-primary lg:hidden">Overview</p>
      ...
      <section className="mt-8 grid gap-4 sm:grid-cols-3">
        <Link href="/dashboard/uploads" className="group flex items-center gap-4 border border-hairline bg-ivory/92 p-5 transition duration-300 ease-premium-out hover:-translate-y-0.5 hover:border-primary/35 hover:shadow-card-hover">
          <span className="grid h-10 w-10 shrink-0 place-items-center border border-primary/30 bg-primary/10 text-primary transition duration-200 group-hover:bg-primary/15">
        ...
        <Link href="/dashboard/downloads" className="group flex items-center gap-4 border border-hairline bg-ivory/92 p-5 transition duration-300 ease-premium-out hover:-translate-y-0.5 hover:border-primary/35 hover:shadow-card-hover">
          <span className="grid h-10 w-10 shrink-0 place-items-center border border-primary/30 bg-primary/10 text-primary transition duration-200 group-hover:bg-primary/15">
        ...
        <Link href="/dashboard/profile" className="group flex items-center gap-4 border border-hairline bg-ivory/92 p-5 transition duration-300 ease-premium-out hover:-translate-y-0.5 hover:border-primary/35 hover:shadow-card-hover">
          <span className="grid h-10 w-10 shrink-0 place-items-center border border-primary/30 bg-primary/10 text-primary transition duration-200 group-hover:bg-primary/15">
